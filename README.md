...
### 🏥 Vita Red — Plataforma de Salud Digital
**Proyecto grupal | Bootcamp Soy Henry | 2025**

Vita Red es una plataforma de salud digital que conecta pacientes y profesionales médicos, simplificando la gestión de turnos y optimizando la experiencia clínica.

🔗 [Repositorio](https://github.com/proyectofinal2025-g1/vita-red-app) | 🌐 [Demo](#) *([Vita Red — Plataforma de Salud Digital](https://vita-red-app.vercel.app/))*
...
- Dashboard Super Admin: Desarrollo del panel administrativo con gestión integral de la plataforma.
- Creación y administración de usuarios (doctores, administradores, pacientes).
